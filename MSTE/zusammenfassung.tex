...
% \begin{figure}[ht]
% \centering
% \includegraphics[width=0.6\linewidth]{images/entity-framework_change-tracker.png}
% \end{figure}
% \begin{figure}[ht]
% \centering
% \includegraphics[width=0.9\linewidth]{images/entity-framework_change-tracker-example.png}
% \end{figure}
...
% % \begin{figure}[!ht]
% % \centering
% % \includegraphics[width=0.8\linewidth]{images/grpc-architecture}
...
% % \begin{figure}[!ht]
% % \centering
% % \includegraphics[width=0.8\linewidth]{images/grpc-architecture-layers}
...
% % \begin{figure}[!ht]
% % \centering
% % \includegraphics[width=0.8\linewidth]{images/grpc-architecture-communication}
